...
<html lang="en">
 <head>
    ...
    <style>
      ...
      .card {
          background: rgba(255, 255, 255, 0.92); /* light transparency so background shows slightly */
          border-radius: 15px;
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        <div class="text-center">
                            <a href="index.html" class="mb-5 d-block auth-logo"></a>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="admin_process.py" method="post">
                                    <div class="mb-3">
