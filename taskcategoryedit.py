...
# Fetch record
cur.execute("SELECT * FROM task_category_master WHERE id=%s", (id,))
row = cur.fetchone()
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0">Edit Task Category</h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="taskcategoryupdate.py">
              ...
              <div class="row align-items-start">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="description" value="{row['description'] or ''}"
                           class="form-control form-control-sm"
