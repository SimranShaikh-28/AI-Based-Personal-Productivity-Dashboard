      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="companyprocess.py">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="address" class="form-control form-control-sm" 
                      style="border:1px solid black !important;" minlength="5" required>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="company_name" class="form-control form-control-sm" 
                      style="border:1px solid black !important;" required pattern="[A-Za-z0-9& ]{2,100}" 
