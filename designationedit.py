...
cur.execute("SELECT * FROM designation_master WHERE id=%s", (id,))
row = cur.fetchone()
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="designationupdate.py">
              ...
              <div class="row align-items-start">
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" name="designation_name" value="{row['designation_name']}"
